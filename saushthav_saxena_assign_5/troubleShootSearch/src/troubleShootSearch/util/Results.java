...
/* * Java Queue Reference: https://www.geeksforgeeks.org/queue-interface-java/
* Results to I/O results for the assignment5 implementation
...
public class Results implements FileDisplayInterface, StdoutDisplayInterface {
    ...
    public Results(String filename) {
        MyLogger.writeMessage("[RESULTS CONSTRUCTOR]: Initializing Results constructor.", MyLogger.DebugLevel.CONSTRUCTOR);
